...
namespace Permillity
{
    public class PermillityOptions
    {
        ...
        /// <param name="useMySql">Should use mysql database. If false, and in memory and sqlite is false, ms sql server will be used.</param>
        /// <param name="useSqlite">Should use sqlite database. If false, and in memory and mysql is false, ms sql server will be used.</param>
        ...
        public PermillityOptions(bool useInMemory = true, bool useMySql = false, bool useSqlite = false, string connectionString = null, int databaseBatchSize = 50, bool useLogger = false, string[] ignoreEndpoints = null)
        {
